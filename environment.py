...
class Environment:
    ...
    def __init__(self, size):
        ...
        self.grid = [[[0, 0, None] for __ in range(width)] for j in range(height)]

    def setCapacity(self, location, value):
        (i, j) = location
        self.grid[i][j][0] = value

    def getCapacity(self, location):
        (i, j) = location
    ...
    def addFoodSite(self, location, maxCapacity):
